document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i = 0; i < squares.length; i++) {
        (function (index) {
            squares[i].onclick = function () {
                if ((index >= 35) || (index + 7 < squares.length && squares[index + 7].classList.contains('taken'))) {
                    if (currentPlayer === 1) {
    ...
    function checkBoard() {
        const winningArrays = [
            ...
            [11, 7, 23, 29], [10, 11], [12, 11, 10, 9], [15, 16, 17, 18], 
            [19, 18, 17, 16], [22, 23, 24, 25], [26, 25, 24, 23], [29, 30, 31, 32], 
            [33, 32, 31, 30], [36, 37, 38, 39], [40, 39, 38, 37], [7, 14, 21, 28], 
